...
enum class EventType {
    ...
    // Evolution system events (Phase NE)
    EVOLUTION_REUNION_RESOLVED,
    EVOLUTION_BOND_UPDATED,
    EVOLUTION_EPISODE_SAVED,
    EVOLUTION_SEMANTIC_FACTS_UPDATED,
    EVOLUTION_HABIT_UPDATED,
    EVOLUTION_TRAIT_DRIFTED,
    UNKNOWN;
